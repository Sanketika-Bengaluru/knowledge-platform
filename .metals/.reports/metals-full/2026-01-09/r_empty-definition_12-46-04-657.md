error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/src/test/java/org/sunbird/test/BaseTest.java:_empty_/AuthTokens#none#
file://<WORKSPACE>/ontology-engine/graph-dac-api/src/test/java/org/sunbird/test/BaseTest.java
empty definition using pc, found symbol in pc: _empty_/AuthTokens#none#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 2818
uri: file://<WORKSPACE>/ontology-engine/graph-dac-api/src/test/java/org/sunbird/test/BaseTest.java
text:
```scala
