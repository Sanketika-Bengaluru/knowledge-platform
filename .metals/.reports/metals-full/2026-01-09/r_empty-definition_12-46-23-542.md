error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/dac/model/Relation.java:SystemProperties/IL_FUNC_OBJECT_TYPE#
file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/dac/model/Relation.java
empty definition using pc, found symbol in pc: SystemProperties/IL_FUNC_OBJECT_TYPE#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 4993
uri: file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/dac/model/Relation.java
text:
```scala
