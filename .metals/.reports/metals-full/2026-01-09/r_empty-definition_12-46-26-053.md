error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/service/util/GraphQueryGenerationUtil.java:SystemProperties/IL_SEQUENCE_INDEX#
file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/service/util/GraphQueryGenerationUtil.java
empty definition using pc, found symbol in pc: SystemProperties/IL_SEQUENCE_INDEX#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 5815
uri: file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/service/util/GraphQueryGenerationUtil.java
text:
```scala
