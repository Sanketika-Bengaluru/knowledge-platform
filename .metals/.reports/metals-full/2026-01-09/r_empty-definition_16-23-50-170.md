error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/dac/util/GremlinOperationsUtil.java:org/apache/tinkerpop/gremlin/process/traversal/dsl/graph/GraphTraversal#
file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/dac/util/GremlinOperationsUtil.java
empty definition using pc, found symbol in pc: org/apache/tinkerpop/gremlin/process/traversal/dsl/graph/GraphTraversal#
...
public class GremlinOperationsUtil {
    ...
    public static Edge createEdge(String graphId, String startNodeId, Relation relation, String endNodeId) {
        ...
        try {
            GraphTraversal<Edge, Edge> edgeTraversal = g.V().has(IL_UNIQUE_ID, startNodeId)
