error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/service/util/BaseQueryGenerationUtil.java:GraphDACParams/CREATE#
file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/service/util/BaseQueryGenerationUtil.java
empty definition using pc, found symbol in pc: GraphDACParams/CREATE#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 14046
uri: file://<WORKSPACE>/ontology-engine/graph-dac-api/src/main/java/org/sunbird/graph/service/util/BaseQueryGenerationUtil.java
text:
```scala
